...
namespace WebApiExample.Web.Controllers
{
    public class AuthController : Controller
    {
        ...
        public IActionResult Login(LoginViewModel login)
        {
            ...
            {
                ModelState.AddModelError("Username", "The Model Is Not Valid");
                return View(login);
            }
        }
    }
